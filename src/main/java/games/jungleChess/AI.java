...
public class AI extends BaseAI {
    ...
    public String getName() {
        ...
        return "JungleChess Java Player"; // REPLACE THIS WITH YOUR TEAM NAME!
     ...
     *
     * @return A string formatting for the move you want to make. If the move is invalid or not properly formatted you will lose the game.
     */
