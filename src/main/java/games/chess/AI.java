...
public class AI extends BaseAI {
     ...
     *
     * @return A string in Standard Algebraic Notation (SAN) for the move you want to make. If the move is invalid or not properly formatted you will lose the game.
     */
